...
def _build_files_row(win, left: QVBoxLayout) -> None:
    ...
    win.btn_toggle_info = QPushButton("Hide Info")
    win.btn_toggle_info.setCheckable(True)
    win.btn_add.setMinimumWidth(140)
    win.btn_remove.setMinimumWidth(140)
    win.btn_clear.setMinimumWidth(140)
    win.btn_toggle_info.setMinimumWidth(140)
...
def _build_info_panel(win) -> None:
    ...
    right = QVBoxLayout(win.right_panel)
    right.setContentsMargins(0, 0, 0, 0)
    right.setSpacing(8)
    win.content_splitter.addWidget(win.right_panel)
